...
var INJECT_DECORATOR_PATH = "@yuzu/yep-app/decorators";
...
function hasInjectDecoratorInSource(data) {
    return /@inject(.*)/.test(data);
}

module.exports = function AutoDecorateInjectTransfomer(writer) {
    this.write = function (data) {
        var dependencies = findDependencies(data);
        if (dependencies.length && !hasInjectDecoratorInSource(data)) { // Skip if module is already using inject.
