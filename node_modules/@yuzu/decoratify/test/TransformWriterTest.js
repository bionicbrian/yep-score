...
import fs from "fs";
import TransformWriter from "../lib/TransformWriter";

var ES_EXPORT_EXPR = TransformWriter.ES_EXPORT_EXPR;
var NODE_EXPORT_EXPR = TransformWriter.NODE_EXPORT_EXPR;

var getModuleBody = (nameOfFile) => fs.readFileSync(`${__dirname}/samples/${nameOfFile}.js`, "utf8");
var modulesToTest = [["es-module-export", ES_EXPORT_EXPR], ["node-module-export", NODE_EXPORT_EXPR]];

describe("TransformWriter:", function () {
    modulesToTest.forEach(([mod, EXPORT_EXPR]) => {
        describe("Using sample: " + mod + ":", () => {
            beforeEach(() => {
            ...
            describe("when adding a decorator", () => {
                beforeEach(() => {
                    ...
                    this.firstExpectedAnnotation = ` = (foo("awesome", true)(${EXPORT_EXPR})) || ${EXPORT_EXPR};`;
                });

                it("should appear in the body", () => {
                    this.writer.body.should.have.string(EXPORT_EXPR + this.firstExpectedAnnotation);
                });

                describe("and when adding a second decorator", () => {
                    beforeEach(() => {
                        this.writer.decorateExport("baz", []);
                        this.secondExpectedAnnotation = ` = (baz()(${EXPORT_EXPR})) || ${EXPORT_EXPR};`;
                    });

                    it("should have the new content in the body", () => {
                        this.writer.body.should.have.string(EXPORT_EXPR + this.secondExpectedAnnotation);
                    });
            ...
            describe("when appending a property on the default export of the file", () => {
                ...
                it("should appear in the body", () => {
                    this.writer.body.should.have.string(EXPORT_EXPR + this.firstExpectedPropSet);
                });
                ...
                describe("and when adding a second property on the export", () => {
                    ...
                    it("should have the new content in the body", () => {
                        this.writer.body.should.have.string(EXPORT_EXPR + this.secondExpectedPropSet);
                    });
