...
import fs from "fs";
import InjectTransformer from "../lib/AutoDecorateInjectTransformer";
...
var noDepsModules = ["node-no-default-export", "es-no-default-export", "es-class-export-manual-inject"];
